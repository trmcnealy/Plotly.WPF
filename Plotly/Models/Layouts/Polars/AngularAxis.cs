...
using Plotly.Models.Layouts.Polars.AngularAxes;
...
namespace Plotly.Models.Layouts.Polars
{
    ...
    public class AngularAxis : IEquatable<AngularAxis>
    {
        ...
        public JsNumber? Period { get; set; }

        /// <summary>
        ///     Sets the direction corresponding to positive angles.
        /// </summary>
        [JsonPropertyName(@"direction")]
        public AngularAxes.DirectionEnum? Direction { get; set; }
        ...
        public bool Equals([AllowNull] AngularAxis other)
        {
            ...
            return (Visible       == other.Visible       && Visible       != null && other.Visible       != null && Visible.Equals(other.Visible))                                      &&
                   ...
                   (Period      == other.Period      && Period      != null && other.Period      != null && Period.Equals(other.Period))                                                &&
