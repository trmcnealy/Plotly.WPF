...
using Plotly.Models.Layouts.Scenes.ZAxes;
...
namespace Plotly.Models.Layouts.Scenes
{
    ...
    public class ZAxis : IEquatable<ZAxis>
    {
        ...
        public ZAxes.Title Title { get; set;} 
        ...
        public ZAxes.CalendarEnum? Calendar { get; set;} 
        ...
        {
            if (!(obj is ZAxis other)) return false;

            return ReferenceEquals(this, obj) || Equals(other);
        }

        
        public bool Equals([AllowNull] ZAxis other)
        {
            ...
            return 
                ...
                (
                    ...
                    SpikeSides != null && other.SpikeSides != null &&
                ...
                (
                    ...
                    ShowBackground != null && other.ShowBackground != null &&
                ...
                (
                    ...
                    ShowAxesLabels != null && other.ShowAxesLabels != null &&
        ...
        /// <summary>
        ///     Checks for equality of the left ZAxis and the right ZAxis.
        /// </summary>
        /// <param name="left">Left ZAxis.</param>
        /// <param name="right">Right ZAxis.</param>
        /// <returns>Boolean</returns>
        public static bool operator == (ZAxis left, ZAxis right)
        {
            return Equals(left, right);
        }

        /// <summary>
        ///     Checks for inequality of the left ZAxis and the right ZAxis.
        /// </summary>
        /// <param name="left">Left ZAxis.</param>
        /// <param name="right">Right ZAxis.</param>
        /// <returns>Boolean</returns>
        ...
        /// </summary>
        /// <returns>ZAxis</returns>
        public ZAxis DeepClone()
        {
            using MemoryStream ms = new();
            
            JsonSerializer.SerializeAsync(ms, this);
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<ZAxis>(ms).Result;
        }
    }
}