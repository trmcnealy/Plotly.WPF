...
using Plotly.Models.Layouts.Ternarys.CAxes;
...
namespace Plotly.Models.Layouts.Ternarys
{
    ...
    [Serializable]
    public class CAxis : IEquatable<CAxis>
    {
        /// <summary>
        ///     Gets or sets the Title.
        /// </summary>
        [JsonPropertyName(@"title")]
        public CAxes.Title Title { get; set;} 
        ...
        {
            if (!(obj is CAxis other)) return false;
        ...
        /// <summary>
        ///     Checks for equality of the left CAxis and the right CAxis.
        /// </summary>
        /// <param name="left">Left CAxis.</param>
        /// <param name="right">Right CAxis.</param>
        /// <returns>Boolean</returns>
        public static bool operator == (CAxis left, CAxis right)
        {
            return Equals(left, right);
        }

        /// <summary>
        ///     Checks for inequality of the left CAxis and the right CAxis.
        /// </summary>
        /// <param name="left">Left CAxis.</param>
        /// <param name="right">Right CAxis.</param>
        /// <returns>Boolean</returns>
        ...
        /// </summary>
        /// <returns>CAxis</returns>
        public CAxis DeepClone()
        {
            using MemoryStream ms = new();
            
            JsonSerializer.SerializeAsync(ms, this);
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<CAxis>(ms).Result;
        }
    }
}