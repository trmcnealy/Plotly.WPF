...
using Plotly.Models.Traces.Candlesticks;

using Stream = Plotly.Models.Traces.Candlesticks.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Candlestick : ITrace, IEquatable<Candlestick>
    {
        ...
        public static bool operator ==(Candlestick left,
                                       Candlestick right)
        {
        ...
        public Candlestick DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<Candlestick>(ms).Result;
        }
    }
}
