    ...
    public class AAxis : IEquatable<AAxis>
    {
        ...
        public bool Equals([AllowNull] AAxis other)
        {
            ...
            return (Color     == other.Color     && Color     != null && other.Color     != null && Color.Equals(other.Color))                                                          &&
                   ...
                   (CheaterType == other.CheaterType && CheaterType != null && other.CheaterType != null && CheaterType.Equals(other.CheaterType))                                      &&
                   ...
                   (LabelPadding     == other.LabelPadding     && LabelPadding     != null && other.LabelPadding     != null && LabelPadding.Equals(other.LabelPadding))                &&
                   (LabelPrefix      == other.LabelPrefix      && LabelPrefix      != null && other.LabelPrefix      != null && LabelPrefix.Equals(other.LabelPrefix))                  &&
                   (LabelSuffix      == other.LabelSuffix      && LabelSuffix      != null && other.LabelSuffix      != null && LabelSuffix.Equals(other.LabelSuffix))                  &&
                   ...
                   (MinorGridCount   == other.MinorGridCount   && MinorGridCount   != null && other.MinorGridCount   != null && MinorGridCount.Equals(other.MinorGridCount))            &&
                   (MinorGridWidth   == other.MinorGridWidth   && MinorGridWidth   != null && other.MinorGridWidth   != null && MinorGridWidth.Equals(other.MinorGridWidth))            &&
                   (MinorGridColor   == other.MinorGridColor   && MinorGridColor   != null && other.MinorGridColor   != null && MinorGridColor.Equals(other.MinorGridColor))            &&
                   (StartLine        == other.StartLine        && StartLine        != null && other.StartLine        != null && StartLine.Equals(other.StartLine))                      &&
                   (StartLineColor   == other.StartLineColor   && StartLineColor   != null && other.StartLineColor   != null && StartLineColor.Equals(other.StartLineColor))            &&
                   (StartLineWidth   == other.StartLineWidth   && StartLineWidth   != null && other.StartLineWidth   != null && StartLineWidth.Equals(other.StartLineWidth))            &&
                   (EndLine          == other.EndLine          && EndLine          != null && other.EndLine          != null && EndLine.Equals(other.EndLine))                          &&
                   (EndlineWidth     == other.EndlineWidth     && EndlineWidth     != null && other.EndlineWidth     != null && EndlineWidth.Equals(other.EndlineWidth))                &&
                   (EndlineColor     == other.EndlineColor     && EndlineColor     != null && other.EndlineColor     != null && EndlineColor.Equals(other.EndlineColor))                &&
                   ...
                   (ArrayTick0       == other.ArrayTick0       && ArrayTick0       != null && other.ArrayTick0       != null && ArrayTick0.Equals(other.ArrayTick0))                    &&
                   (ArrayDTick       == other.ArrayDTick       && ArrayDTick       != null && other.ArrayDTick       != null && ArrayDTick.Equals(other.ArrayDTick))                    &&
        ...
        public static bool operator ==(AAxis left,
                                       AAxis right)
        {
