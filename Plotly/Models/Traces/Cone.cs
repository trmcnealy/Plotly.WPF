...
using Plotly.Models.Traces.Cones;

using Stream = Plotly.Models.Traces.Cones.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Cone : ITrace, IEquatable<Cone>
    {
        ...
        public static bool operator ==(Cone left,
                                       Cone right)
        {
        ...
        public Cone DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<Cone>(ms).Result;
        }
    }
}
