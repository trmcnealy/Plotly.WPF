...
using Plotly.Models.Traces.FunnelAreas;

using Stream = Plotly.Models.Traces.FunnelAreas.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class FunnelArea : ITrace, IEquatable<FunnelArea>
    {
        ...
        public JsNumber? AspectRatio { get; set; }

        /// <summary>
        ///     Sets the ratio between bottom length and maximum top length.
        /// </summary>
        [JsonPropertyName(@"baseratio")]
        public JsNumber? BaseRatio { get; set; }
        ...
        public static bool operator ==(FunnelArea left,
                                       FunnelArea right)
        {
        ...
        public FunnelArea DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<FunnelArea>(ms).Result;
        }
    }
}
