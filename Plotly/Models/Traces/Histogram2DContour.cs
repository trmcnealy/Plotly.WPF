...
using Plotly.Models.Traces.Histogram2DContours;

using Stream = Plotly.Models.Traces.Histogram2DContours.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Histogram2DContour : ITrace, IEquatable<Histogram2DContour>
    {
        ...
        public Histogram2DContours.Contours Contours { get; set;} 
        ...
        public Histogram2DContour DeepClone()
        {
            ...
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<Histogram2DContour>(ms).Result;
        }
    }
}