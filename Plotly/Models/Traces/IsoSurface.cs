...
using Plotly.Models.Traces.IsoSurfaces;

using Stream = Plotly.Models.Traces.IsoSurfaces.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class IsoSurface : ITrace, IEquatable<IsoSurface>
    {
        ...
        public IsoSurfaces.Surface Surface { get; set;} 
        ...
        public IsoSurfaces.Contour Contour { get; set;} 
        ...
        public IsoSurface DeepClone()
        {
            ...
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<IsoSurface>(ms).Result;
        }
    }
}