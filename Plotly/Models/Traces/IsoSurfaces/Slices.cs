...
using Plotly.Models.Traces.IsoSurfaces.Slicess;
...
namespace Plotly.Models.Traces.IsoSurfaces
{
    ...
    public class Slices : IEquatable<Slices>
    {
        ...
        public static bool operator ==(Slices left,
                                       Slices right)
        {
        ...
        public Slices DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<Slices>(ms).Result;
        }
    }
}
