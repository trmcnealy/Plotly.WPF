...
namespace Plotly.Models.Traces.ParCoordss
{
    ...
    public class RangeFont : IEquatable<RangeFont>
    {
        ...
        /// <summary>
        ///     Checks for equality of the left RangeFont and the right RangeFont.
        /// </summary>
        ...
        /// <summary>
        ///     Checks for inequality of the left RangeFont and the right RangeFont.
        /// </summary>
        /// <param name="left">Left RangeFont.</param>
        /// <param name="right">Right RangeFont.</param>
        /// <returns>Boolean</returns>
