    ...
    public class Sankey : ITrace, IEquatable<Sankey>
    {
        ...
        public bool Equals([AllowNull] Sankey other)
        {
            ...
            return (Type    == other.Type    && Type    != null && other.Type    != null && Type.Equals(other.Type))                                                 &&
                   ...
                   (ValueSuffix    == other.ValueSuffix    && ValueSuffix    != null && other.ValueSuffix    != null && ValueSuffix.Equals(other.ValueSuffix))       &&
                   ...
                   (Node           == other.Node           && Node           != null && other.Node           != null && Node.Equals(other.Node))                     &&
                   (Link           == other.Link           && Link           != null && other.Link           != null && Link.Equals(other.Link))                     &&
        ...
        public static bool operator ==(Sankey left,
                                       Sankey right)
        {
