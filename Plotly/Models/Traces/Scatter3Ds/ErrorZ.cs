...
using Plotly.Models.Traces.Scatter3Ds.ErrorZs;
...
namespace Plotly.Models.Traces.Scatter3Ds
{
    ...
    [Serializable]
    public class ErrorZ : IEquatable<ErrorZ>
    {
        /// <summary>
        ...
        {
            if (!(obj is ErrorZ other)) return false;

            return ReferenceEquals(this, obj) || Equals(other);
        }

        
        public bool Equals([AllowNull] ErrorZ other)
        {
        ...
        /// <summary>
        ///     Checks for equality of the left ErrorZ and the right ErrorZ.
        /// </summary>
        /// <param name="left">Left ErrorZ.</param>
        /// <param name="right">Right ErrorZ.</param>
        /// <returns>Boolean</returns>
        public static bool operator == (ErrorZ left, ErrorZ right)
        {
            return Equals(left, right);
        }

        /// <summary>
        ///     Checks for inequality of the left ErrorZ and the right ErrorZ.
        /// </summary>
        /// <param name="left">Left ErrorZ.</param>
        /// <param name="right">Right ErrorZ.</param>
        /// <returns>Boolean</returns>
        ...
        /// </summary>
        /// <returns>ErrorZ</returns>
        public ErrorZ DeepClone()
        {
            using MemoryStream ms = new();
            
            JsonSerializer.SerializeAsync(ms, this);
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<ErrorZ>(ms).Result;
        }
    }
}