...
using Plotly.Models.Traces.ScatterPolarGls;

using Stream = Plotly.Models.Traces.ScatterPolarGls.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class ScatterPolarGl : ITrace, IEquatable<ScatterPolarGl>
    {
        ...
        {
            if(!(obj is ScatterPolarGl other))
                return false;
        ...
        public static bool operator ==(ScatterPolarGl left,
                                       ScatterPolarGl right)
        {
        ...
        public ScatterPolarGl DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<ScatterPolarGl>(ms).Result;
        }
    }
}
