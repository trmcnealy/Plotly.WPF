...
namespace Plotly.Models.Traces.ScatterPolarGls.Markers.ColorBars
{
    /// <summary>
    ///     The TickFont class.
    /// </summary>
    ...
    public class TickFont : IEquatable<TickFont>
    {
        ...
        {
            if (!(obj is TickFont other)) return false;
        ...
        public static bool operator == (TickFont left, TickFont right)
        {
