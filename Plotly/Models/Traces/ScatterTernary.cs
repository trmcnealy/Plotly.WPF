...
using Plotly.Models.Traces.ScatterTernarys;

using Stream = Plotly.Models.Traces.ScatterTernarys.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    [Serializable]
    public class ScatterTernary : ITrace, IEquatable<ScatterTernary>
    {
        /// <inheritdoc/>
        [JsonPropertyName(@"type")]
        public TraceTypeEnum? Type { get; } = TraceTypeEnum.ScatterTernary;
        ...
        {
            if(!(obj is ScatterTernary other))
                return false;
        ...
        public bool Equals([AllowNull] ScatterTernary other)
        {
            ...
            return (Type        == other.Type        && Type        != null && other.Type        != null && Type.Equals(other.Type))                                                                &&
                   ...
                   (Equals(C, other.C) || C != null && other.C != null && C.SequenceEqual(other.C))                                                                                                 &&
                   (Sum  == other.Sum  && Sum  != null && other.Sum  != null && Sum.Equals(other.Sum))                                                                                              &&
                   ...
                   (CSrc             == other.CSrc             && CSrc             != null && other.CSrc             != null && CSrc.Equals(other.CSrc))                       &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if(CSrc != null)
                    hashCode = hashCode * 59 + CSrc.GetHashCode();
        ...
        /// <summary>
        ///     Checks for equality of the left ScatterTernary and the right ScatterTernary.
        /// </summary>
        /// <param name="left">Left ScatterTernary.</param>
        /// <param name="right">Right ScatterTernary.</param>
        /// <returns>Boolean</returns>
        public static bool operator ==(ScatterTernary left,
                                       ScatterTernary right)
        {
            return Equals(left, right);
        }

        /// <summary>
        ///     Checks for inequality of the left ScatterTernary and the right ScatterTernary.
        /// </summary>
        /// <param name="left">Left ScatterTernary.</param>
        /// <param name="right">Right ScatterTernary.</param>
        /// <returns>Boolean</returns>
        ...
        /// </summary>
        /// <returns>ScatterTernary</returns>
        public ScatterTernary DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<ScatterTernary>(ms).Result;
        }
    }
}
