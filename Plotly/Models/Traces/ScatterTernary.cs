...
namespace Plotly.Models.Traces
{
    ...
    public class ScatterTernary : ITrace, IEquatable<ScatterTernary>
    {
        ...
        {
            if (!(obj is ScatterTernary other)) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (C != null) hashCode = hashCode * 59 + C.GetHashCode();
                ...
                if (CSrc != null) hashCode = hashCode * 59 + CSrc.GetHashCode();
        ...
        public static bool operator == (ScatterTernary left, ScatterTernary right)
        {
