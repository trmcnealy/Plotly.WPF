...
using Plotly.Models.Traces.Sunbursts;

using Stream = Plotly.Models.Traces.Sunbursts.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Sunburst : ITrace, IEquatable<Sunburst>
    {
        ...
        public Sunburst DeepClone()
        {
            ...
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<Sunburst>(ms).Result;
        }
    }
}