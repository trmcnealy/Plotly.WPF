...
namespace Plotly.Models.Traces.Sunbursts
{
    ...
    public class InsideTextFont : IEquatable<InsideTextFont>
    {
        ...
        {
            if(!(obj is InsideTextFont other))
                return false;
        ...
        public static bool operator ==(InsideTextFont left,
                                       InsideTextFont right)
        {
        ...
        public InsideTextFont DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<InsideTextFont>(ms).Result;
        }
    }
}
