...
namespace Plotly.Models.Traces.Sunbursts
{
    ...
    public class OutsideTextFont : IEquatable<OutsideTextFont>
    {
        ...
        {
            if(!(obj is OutsideTextFont other))
                return false;
        ...
        public static bool operator ==(OutsideTextFont left,
                                       OutsideTextFont right)
        {
        ...
        public OutsideTextFont DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<OutsideTextFont>(ms).Result;
        }
    }
}
