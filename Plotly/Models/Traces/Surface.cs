...
using Plotly.Models.Traces.Surfaces;

using Stream = Plotly.Models.Traces.Surfaces.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Surface : ITrace, IEquatable<Surface>
    {
        ...
        public List<object> SurfaceColor { get; set; }
        ...
        public Surfaces.Contours Contours { get; set; }
        ...
        public bool Equals([AllowNull] Surface other)
        {
            ...
            return (Type        == other.Type        && Type        != null && other.Type        != null && Type.Equals(other.Type))                                              &&
                   ...
                   (Equals(SurfaceColor, other.SurfaceColor) || SurfaceColor != null && other.SurfaceColor != null && SurfaceColor.SequenceEqual(other.SurfaceColor))             &&
                   ...
                   (HideSurface    == other.HideSurface    && HideSurface    != null && other.HideSurface    != null && HideSurface.Equals(other.HideSurface))                    &&
                   ...
                   (SurfaceColorSrc  == other.SurfaceColorSrc  && SurfaceColorSrc  != null && other.SurfaceColorSrc  != null && SurfaceColorSrc.Equals(other.SurfaceColorSrc))    &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if(HideSurface != null)
                    hashCode = hashCode * 59 + HideSurface.GetHashCode();
                ...
                if(SurfaceColorSrc != null)
                    hashCode = hashCode * 59 + SurfaceColorSrc.GetHashCode();
