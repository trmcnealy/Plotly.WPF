...
using Plotly.Models.Traces.TreeMaps.Markers;
...
namespace Plotly.Models.Traces.TreeMaps
{
    ...
    public class Marker : IEquatable<Marker>
    {
        ...
        public bool Equals([AllowNull] Marker other)
        {
            ...
            return (Pad == other.Pad && Pad != null && other.Pad != null && Pad.Equals(other.Pad))                                                                   &&
                   (Equals(Colors, other.Colors) || Colors != null && other.Colors != null && Colors.SequenceEqual(other.Colors))                                    &&
                   (DepthFade      == other.DepthFade      && DepthFade      != null && other.DepthFade      != null && DepthFade.Equals(other.DepthFade))           &&
