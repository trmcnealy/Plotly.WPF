...
using Plotly.Models.Traces.Volumes;

using Stream = Plotly.Models.Traces.Volumes.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    [Serializable]
    public class Volume : ITrace, IEquatable<Volume>
    {
        /// <inheritdoc/>
        ...
        public JsNumber? IsoMin { get; set;} 

        /// <summary>
        ///     Sets the maximum boundary for iso-surface plot.
        /// </summary>
        [JsonPropertyName(@"isomax")]
        public JsNumber? IsoMax { get; set;} 

        /// <summary>
        ///     Gets or sets the Surface.
        /// </summary>
        [JsonPropertyName(@"surface")]
        public Volumes.Surface Surface { get; set;} 
        ...
        public Volumes.Contour Contour { get; set;} 
        ...
        {
            if (!(obj is Volume other)) return false;
        ...
        public bool Equals([AllowNull] Volume other)
        {
            ...
            return 
                ...
                (
                    IsoMin == other.IsoMin &&
                    IsoMin != null && other.IsoMin != null &&
                    IsoMin.Equals(other.IsoMin)
                ) && 
                (
                    IsoMax == other.IsoMax &&
                    IsoMax != null && other.IsoMax != null &&
                    IsoMax.Equals(other.IsoMax)
                ) && 
                (
                    Surface == other.Surface &&
                    Surface != null && other.Surface != null &&
                    Surface.Equals(other.Surface)
                ) && 
                (
                    SpaceFrame == other.SpaceFrame &&
                    SpaceFrame != null && other.SpaceFrame != null &&
                    SpaceFrame.Equals(other.SpaceFrame)
                ) && 
                (
                    Slices == other.Slices &&
                    Slices != null && other.Slices != null &&
                    Slices.Equals(other.Slices)
                ) && 
                (
                    Caps == other.Caps &&
                    Caps != null && other.Caps != null &&
                ...
                (
                    ...
                    OpacityScale != null && other.OpacityScale != null &&
        ...
        /// <summary>
        ///     Checks for equality of the left Volume and the right Volume.
        /// </summary>
        ...
        /// <summary>
        ///     Checks for inequality of the left Volume and the right Volume.
        /// </summary>
        /// <param name="left">Left Volume.</param>
        /// <param name="right">Right Volume.</param>
        /// <returns>Boolean</returns>
        ...
        public Volume DeepClone()
        {
            ...
            ms.Position = 0;
            return JsonSerializer.DeserializeAsync<Volume>(ms).Result;
        }
    }
}