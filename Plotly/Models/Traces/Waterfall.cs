...
using Plotly.Models.Traces.Waterfalls;

using Stream = Plotly.Models.Traces.Waterfalls.Stream;
...
namespace Plotly.Models.Traces
{
    ...
    public class Waterfall : ITrace, IEquatable<Waterfall>
    {
        ...
        public List<object>? Measure { get; set; }

        /// <summary>
        ///     Sets where the bar base is drawn (in position axis units).
        /// </summary>
        [JsonPropertyName(@"base")]
        public JsNumber? Base { get; set; }
        ...
        public bool Equals([AllowNull] Waterfall other)
        {
            ...
            return (Type        == other.Type        && Type        != null && other.Type        != null && Type.Equals(other.Type))                                              &&
                   ...
                   (Equals(Measure, other.Measure) || Measure != null && other.Measure != null && Measure.SequenceEqual(other.Measure))                                           &&
                   ...
                   (Totals           == other.Totals           && Totals           != null && other.Totals           != null && Totals.Equals(other.Totals))                                        &&
                   ...
                   (MeasureSrc       == other.MeasureSrc       && MeasureSrc       != null && other.MeasureSrc       != null && MeasureSrc.Equals(other.MeasureSrc))                                &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if(MeasureSrc != null)
                    hashCode = hashCode * 59 + MeasureSrc.GetHashCode();
        ...
        public static bool operator ==(Waterfall left,
                                       Waterfall right)
        {
        ...
        public Waterfall DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<Waterfall>(ms).Result;
        }
    }
}
