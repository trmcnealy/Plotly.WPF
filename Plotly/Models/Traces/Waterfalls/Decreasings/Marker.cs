...
using Plotly.Models.Traces.Waterfalls.Decreasings.Markers;

namespace Plotly.Models.Traces.Waterfalls.Decreasings
{
    /// <summary>
    ///     The Marker class.
    /// </summary>
    ...
    public class Marker : IEquatable<Marker>
    {
        ...
        public bool Equals([AllowNull] Marker other)
        {
            ...
            return (Color == other.Color && Color != null && other.Color != null && Color.Equals(other.Color)) && (Line == other.Line && Line != null && other.Line != null && Line.Equals(other.Line));
        }
