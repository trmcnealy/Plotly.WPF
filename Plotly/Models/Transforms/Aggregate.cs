...
using Plotly.Models.Transforms.Aggregates;
    ...
    public class Aggregate : ITransform, IEquatable<Aggregate>
    {
        ...
        public bool Equals([AllowNull] Aggregate other)
        {
            ...
            return (Type    == other.Type    && Type    != null && other.Type    != null && Type.Equals(other.Type))                                                  &&
                   ...
                   (Groups  == other.Groups  && Groups  != null && other.Groups  != null && Groups.Equals(other.Groups))                                              &&
                   (Equals(GroupsArray,  other.GroupsArray)  || GroupsArray  != null && other.GroupsArray  != null && GroupsArray.SequenceEqual(other.GroupsArray))   &&
                   (Equals(Aggregations, other.Aggregations) || Aggregations != null && other.Aggregations != null && Aggregations.SequenceEqual(other.Aggregations)) &&
        ...
        public static bool operator ==(Aggregate left,
                                       Aggregate right)
        {
        ...
        public Aggregate DeepClone()
        {
            ...
            return JsonSerializer.DeserializeAsync<Aggregate>(ms).Result;
        }
    }
}
